...
[.text-center]
****
link:../index.html[[HOME\]] / link:./index.html[[ARTICLES\]]
****
...
Although I am totally basing it on Intel manuals, some mistakes could pass. If you find one, feel free to warn me. :)
...
== Registers
One of the most confusing of x86 is that registers are not independent; they overlap.

The same physical register can be accessed at different sizes:

image::../assets/rax.svg[opts=interactive,title="Example with RAX"]
